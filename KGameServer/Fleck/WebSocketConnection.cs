...
namespace Fleck
{
  public class WebSocketConnection : IWebSocketConnection
  {
    ...
    {
        //Console.WriteLine("FLECK SEND string message=" + message);
      return Send(message, Handler.FrameText);
    }

    public Task Send(byte[] message)
    {
       // Console.WriteLine("FLECK SEND byte message=" + System.Text.Encoding.ASCII.GetString(message));
        return Send(message, Handler.FrameBinary);
    }

    public Task SendPing(byte[] message)
    {
        //Console.WriteLine("FLECK SendPing byte message=" + System.Text.Encoding.ASCII.GetString(message));
        return Send(message, Handler.FramePing);
    }

    public Task SendPong(byte[] message)
    {
        //Console.WriteLine("FLECK SendPong byte message=" + System.Text.Encoding.ASCII.GetString(message));
